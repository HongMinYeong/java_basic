...
//        System.out.println(temp[2]); // Error
        ...
        // * 배열 변수 선언과 대입 시점이 다르다면 , "new 타입[]"을 중괄호 앞에 붙여야 함
        char[] charArray;
//        charArray = {'A','B','C'};
        ...
        // doubleArray.length = 5; // Error: length 필드는 읽기 전용이라 수정 불가능
...
//////////////////////////////////////////////////////////////////////////////
        ...
        System.out.println(langs[0].equals(langs[2])); //true: 문자열 내용이 동일

//////////////////////////////////////////////////////////////////////////////
        //배열 관련 메소드
        // 배열 복사
        // - 표준 배열은 크기가 고정 -> 더 많은 저장공간이 필요하다면, 더 큰 길이의 배열을 새로 만들어 기존 배열 복사

        //ver1. 반복문 요소를 하나씩 복사
        int[] originArray = {1,2,3};
        int[] newArray = new int[5];
        System.out.println("originArray : " + Arrays.toString(originArray)); //기준 배열 출력
        ...
        // - Object src: 원본 배열
        // - Object srcPos: 원본 배열 복사 시작 인덱스
        // - Object dest: 새로운 배열
        // - int destPos: 새로운 배열 붙여넣기 시작 인덱스1
        ...
        System.out.println("array1 == array3 : " + (array1==array3)); //false
