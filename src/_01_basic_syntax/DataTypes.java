...
public class DataTypes {
    public static void main(String[] args){
        ...
        // 정수형 변수
        int x = 10;
        long y = 100000000L; // long 타입은 뒤에 L, l 붙여야 함
        short z = 32767;
        byte b = 127;
        ...
        char ch = 'A'; //단따옴표로 문자 하나를 선언 -> char 65매핑
        char ch2 = '가'; //44032 매핑
    ...
    /////////////////////////////////////
        ...
        // String 참조형 변수
        // - Java 에서 String 타입은 특별함. 참조형인데 기본형
        // - 기본 자료형은 == 연산자를 통해 비교하지만, String 객체간 비교는 .equals() 메소드 사용
        String greeting = "hello, world!!";

        // 배열 (Array)
        int[] numbers = {1,2,3,4,5}; //각각의 원소가 int이고 크기가 5인 배열원소가 생성

        // 클래스 (Class)
        Person person = new Person("John", 30);
        Person person2 = new Person("minyeong",27);
        ...
        System.out.println("Person 객체 : " + person2.getName() + ", " + person2.getAge());
